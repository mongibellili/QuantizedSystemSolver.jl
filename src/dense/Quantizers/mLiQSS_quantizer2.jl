...
#=  if abs(βjdir-βj)>(abs(βjdir+βj)/2)  || dqjplus*newDiff<0.0 
  ...
  if iscycle
        ...
        if DEBUG #&& printonce==0
          println("nmliqss simulupdate after h=ft-simt inside is iscycle")
          @show qi,qj
        end
        ...
        if DEBUG #&& printonce==0
          println("nmliqss simulupdate after h 2nd guess inside is iscycle")
          @show qi,qj
        end
        maxIter=10000
        ...
        if DEBUG #&& printonce==0
          println("nmliqss simulupdate after h while inside is iscycle")
          @show qi,qj
        end
      ...
      if DEBUG #&& printonce==0
        println("nmliqss simulupdate after  is iscycle")
        @show q
      end
