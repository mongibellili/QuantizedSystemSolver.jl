...
- A LightSol struct.
"""
function createSol(::Val{T},::Val{O}, savedTimes:: Vector{Vector{Float64}},savedVars :: Vector{Vector{Float64}},solver::String,nameof_F::String,absQ::Float64,stats::Stats,ft::Float64) where {T,O}
...
"""
function evaluateSol(sol::Sol{T,O},index::Int,t::Float64) where {T,O}
