...
coefi=[-0.00057016254603761695740615778, -1140.3250641304001419575054, -8.5524376124873223589469262e+08, -2.8508122708869649897226691e+14, 1.7114669426922051413515583e+13, 1.0474193043858423245087585e+18, -2.5668078295588949092296481e+16]
#=  p=Polynomial(coefi)
# @show p
 #r=roots(p)
 r=find_zeros(p, 0.0, 100.0)
