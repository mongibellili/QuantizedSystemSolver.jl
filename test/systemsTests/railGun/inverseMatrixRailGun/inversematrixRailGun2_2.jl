...
@show 2
@variables x,il1,il2,rd1,rd2,rr,rpr,v,is1,is2,Il
#x=3.0
...
b=4.2e-3+0.453*x;a=5.1+4.2e-3+0.453*x  ;λ=a-b;u=[b;b];vec=[1 1]
...
C=[-(rd1+3.88e-3)*il1-(rr+rpr+0.453e-6*v)*Il+rd1*is1;-(rd2+3.88e-3)*il2-(rr+rpr+0.453e-6*v)*Il+rd2*is2]
