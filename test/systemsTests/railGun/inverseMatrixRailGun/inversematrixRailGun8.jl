...
@show 2
@variables x,il1,il2,il3,il4,il5,il6,il7,il8,rd1,rd2,rd3,rd4,rd5,rd6,rd7,rd8,rr,rpr,v,is1,is2,is3,is4,is5,is6,is7,is8,Il
#x=3.0
...
b=4.2e-3+0.453*x;a=5.1+4.2e-3+0.453*x  ;λ=a-b;u=[b;b;b;b;b;b;b;b];vec=[1 1 1 1 1 1 1 1]
