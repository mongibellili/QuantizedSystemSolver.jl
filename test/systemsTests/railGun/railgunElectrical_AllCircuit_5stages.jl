...
t0=1.0
       ...
       discrete = [1e5,1.0,1.0,1e5,1.0,1.0,1e5,1.0,1.0,1e5,0.0,1.0,1e5,0.0,1.0,0.0,1e-3];u = [0.0,20005.75,0.0,0.0,21003.75,0.0,0.0,20001.75,0.0,0.0,20001.75,0.0,0.0,20001.75,0.0,0.0,0.0]
       ...
       manualIntg=discrete[16]; nextT=discrete[17]
    ...
    #=   rrpp=(rpr + rr + 4.53e-7v) 
      ...
      rd11=(-0.00388 - rd1);rd22=(-0.00388 - rd2);rd33=(-0.00388 - rd3);rd44=(-0.00388 - rd4) =#
       ...
       F=0.5*0.453e-6*Il*Il*(1-uf*0.124)-uf*FNmec
          ...
          du[13] =((-(R1+rs51+rd5)*is5+rd5*il5+uc5)/L1)*operate5#*charge3
