...
t0=1.0
          ...
          discrete = [1e5,1e-5,1.0,1e5,1e-5,1.0,1e5,1e-5,1.0,1.0,1.0,0.0,1e-3,1.0,1.0,1.0];u = [0.0,10000.75,0.0,0.0,10000.75,0.0,0.0,10000.75,0.0,0.0,0.0]
        ...
        rr=manualIntg*2.0*sqrt(μ/(3.14*γ))/w
         ...
         # du[9]=start3*(((-rd3-R2-R3)*il3-RR*(I)+rd3*is3)/(L2+L3))#((L2+L3+α)*β)/Δ
          du[9]=operate3*1e6*(((-I*(rpr + rr + 4.53e-7v) + il3*(-0.00388 - rd3) + is3*rd3)*((5.1042 + 0.453x)^2 - ((0.0042 + 0.453x)^2)))+(-I*(rpr + rr + 4.53e-7v) + il2*(-0.00388 - rd2) + is2*rd2)*((0.0042 + 0.453x)^2 - (0.0042 + 0.453x)*(5.1042 + 0.453x))) +((-I*(rpr + rr + 4.53e-7v) + il1*(-0.00388 - rd1) + is1*rd1)*((0.0042 + 0.453x)^2 - (0.0042 + 0.453x)*(5.1042 + 0.453x)))/(132.97872599999997 + 35.34758999999999x)
